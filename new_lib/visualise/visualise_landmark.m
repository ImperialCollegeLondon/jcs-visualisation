function visualise_landmark(t, f, config)
    ...
    scatter3(o(1), o(2), o(3), 'b', 'filled');

    if config.is_right_knee
        med_lat = t.lateral - t.medial;
        quiver3(t.medial(1), t.medial(2), t.medial(3), med_lat(1), med_lat(2), med_lat(3), 0, 'b');
    else
        med_lat = t.medial - t.lateral;
        quiver3(t.lateral(1), t.lateral(2), t.lateral(3), med_lat(1), med_lat(2), med_lat(3), 0, 'b');
    end
    ...
    scatter3(o(1), o(2), o(3), 'r', 'filled');

    if config.is_right_knee
        med_lat = f.lateral - f.medial;
        quiver3(f.medial(1), f.medial(2), f.medial(3), med_lat(1), med_lat(2), med_lat(3), 0, 'r');
    else
        med_lat = f.medial - f.lateral;
        quiver3(f.lateral(1), f.lateral(2), f.lateral(3), med_lat(1), med_lat(2), med_lat(3), 0, 'r');
    end
