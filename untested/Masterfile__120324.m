clear
%%LVDT readouts included in this version
...
intact_dig_folderPath = 'C:\Users\sholthof\OneDrive - Imperial College London\Imperial\PHD\Matlab\CS calculations\SH43\004_Native_Flexion 0-90\Configuration\Project.sVprj'; %folderpath JCS_digitised (original CS)
...
% femur_width=norm(femoral_points(1:3),femoral_points(4:6));
...
passive_flexion=(['C:\Users\sholthof\OneDrive - Imperial College London\Imperial\PHD\Matlab\CS calculations\SH34\042_Triathlon_Flexion 0-90\Data']);
experiment_run=('C:\Users\sholthof\OneDrive - Imperial College London\Imperial\PHD\Matlab\CS calculations\SH34\045_Triathlon_optimised_dynamic_lax_1BW\Data');
...
%     kinematics_final=[flex_kinematics;ext_kinematics];
    ...
    all_JCS{i}=JCS_final;
    all_error{i}=error;
    % all_LVDT{i}=LVDT_data;
end

%% Write kinematics to excel

results_file='C:\Users\sholthof\OneDrive - Imperial College London\Imperial\PHD\Matlab\CS calculations\SH34\SH34.xlsx';
