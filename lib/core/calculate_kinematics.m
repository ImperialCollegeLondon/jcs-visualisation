function output = calculate_kinematics(tdms, transforms, config, is_right_knee)
    ...
    output.add_data("kinematics", rotationsAndTranslations(RB1_T_RB2, is_right_knee));
    output.add_data("kinematics_orig", rotationsAndTranslations(RB1orig_T_RB2orig, is_right_knee));
